...
function HomeScreen({ go }) {
  return <Screen className="home-screen"><Particles />
    <div className="screen-content home-content">
      <div className="logo-pill" role="banner"><div className="logo-star">✦</div><span className="logo-text">EDTECH ISLAND</span></div>
      <div className="glass-card home-card" role="main">
        <div className="solar-header-wrap"><div className="solar-header-accent" /><h1 className="solar-title">Welcome to <span className="gradient-text">Study Island</span></h1></div>
        <div className="subject-preview-row" role="list" aria-label="Available subjects">
          <div className="subject-pill glass-mini" role="listitem"><span className="subject-icon">🔬</span><div className="subject-pill-info"><span className="subject-pill-name">SCIENCE</span><span className="subject-pill-sub">5 Studies Active</span></div></div>
          <div className="subject-pill glass-mini" role="listitem"><span className="subject-icon">🏛️</span><div className="subject-pill-info"><span className="subject-pill-name">HISTORY</span><span className="subject-pill-sub">3 Eras Open</span></div></div>
          <div className="subject-pill glass-mini" role="listitem"><span className="subject-icon">🌍</span><div className="subject-pill-info"><span className="subject-pill-name">GEOGRAPHY</span><span className="subject-pill-sub">6 Continents Mapped</span></div></div>
        </div>
        <div className="cta-group"><button id="btn-start" className="btn-primary" type="button" onClick={() => go("subjects")} aria-label="Start learning"><span className="btn-icon">▶</span> START</button><button id="btn-resume" className="btn-secondary" type="button" onClick={() => go("subjects")} aria-label="Resume learning">RESUME</button></div>
      </div>
    </div>
  </Screen>;
}
