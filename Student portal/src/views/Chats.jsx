...
// Firebase imports (Using the firebase config you provide)
...
export default function Chats() {
  ...
  useEffect(() => {
    ...
    // In a real app, you would query where participants contains currentUser.uid
    // For now, let's fetch all conversations
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      if (!activeChat && chatsData.length > 0 && activeTab !== 'announcements') {
        ...
        <Card className="chats-sidebar">
          ...
          <div className="chats-list">
            {activeTab === 'announcements' ? (
              ...
              <div style={{ padding: '20px', textAlign: 'center', color: '#666' }}>
                <p>No chats found.</p>
                <p style={{fontSize: '0.8rem'}}>Ensure Firebase is configured and DB has data.</p>
              </div>
            )}
          </div>
        </Card>
