...
export default function Chats() {
  ...
  const [lastViewedAnnouncements, setLastViewedAnnouncements] = useState(() => {
    return parseInt(localStorage.getItem('student_last_announcements_view') || '0', 10);
  });
  ...
  useEffect(() => {
    if (activeTab === 'announcements') {
      ...
      localStorage.setItem('student_last_announcements_view', now.toString());
    }
  }, [activeTab]);
      ...
      <Card style={{ padding: '0', display: 'flex', flexDirection: 'column', flex: 1, minHeight: '600px', overflow: 'hidden' }}>
        {activeTab === 'announcements' ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', minHeight: '500px' }}>
            <h3 style={{ color: '#fff', marginBottom: '10px' }}>Coming Soon</h3>
